...
def main():
    ...
    parser.add_argument('--data_dir',       type=str,   default=r'C:\Users\112899\OneDrive - Grundfos\Documents\Kandidat project\Data\finetuning_spec',                     help='Directory containing the training data')
    parser.add_argument('--save_dir',       type=str,   default=r"C:\Users\112899\OneDrive - Grundfos\Documents\Kandidat project\Code\code_outputs\Simple_AE",              help='Directory to save the model and results')
